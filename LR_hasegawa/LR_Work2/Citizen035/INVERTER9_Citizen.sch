...
C {.klayout/salt/Citizen035/Technology/tech/symbols/Xschem/Citizen035/NMOS_MIN.sym} 20 80 0 0 {name=M1 model=nch w=1.2u l=0.4u as=0 ps=0 ad=0 pd=0 m=9}
C {.klayout/salt/Citizen035/Technology/tech/symbols/Xschem/Citizen035/PMOS_MIN.sym} 20 -80 0 0 {name=M2 model=pch w=3.6u l=1.2u as=0 ps=0 ad=0 pd=0 m=9}
