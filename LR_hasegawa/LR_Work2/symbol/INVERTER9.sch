...
C {PMOS_MIN.sym} 20 -80 0 0 {name=M6 model=pch w=3u l=0.35u as=5.6p ps=9u ad=5.6p pd=9u m=9}
C {NMOS_MIN.sym} 20 80 0 0 {name=M8 model=nch w=1u l=0.35u as=2.8p ps=5.5u ad=2.8p pd=5.5u m=9}
