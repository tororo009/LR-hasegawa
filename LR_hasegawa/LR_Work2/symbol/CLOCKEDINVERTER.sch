...
C {PMOS_MIN.sym} 360 -80 0 0 {name=M3 model=pch w=7u l=0.35u as=0 ps=0 ad=0 pd=0 m=1}
...
C {PMOS_MIN.sym} 360 -180 0 0 {name=M5 model=pch w=7u l=0.35u as=1.05u ps=1.05u ad=3.7u pd=3.7u m=1}
