...
C {PMOS_MIN.sym} 20 -80 0 0 {name=M6 model=pch w=1.4u l=0.35u as=1.2p ps=4.6u ad=1.2p pd=4.6u m=1}
C {NMOS_MIN.sym} 20 80 0 0 {name=M8 model=nch w=0.7u l=0.35u as=0.56p ps=3u ad=0.56p pd=3u m=1}
