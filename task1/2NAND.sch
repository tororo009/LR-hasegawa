...
C {.klayout/salt/OpenRule1um/tech/tech/symbols/Xschem/MinedaLIB/NMOS_MIN.sym} 120 30 0 0 {name=M1 model=nch w=9.7u l=1.94u as=0 ps=0 ad=0 pd=0 m=1}
...
C {.klayout/salt/OpenRule1um/tech/tech/symbols/Xschem/MinedaLIB/NMOS_MIN.sym} 120 140 0 0 {name=M4 model=nch w=9.7u l=1.94u as=0 ps=0 ad=0 pd=0 m=1}
C {.klayout/salt/OpenRule1um/tech/tech/symbols/Xschem/MinedaLIB/CAP_MIN.sym} 250 0 0 0 {name=C1
m=1
value=10f
footprint=1206
device=ceramic}
C {/usr/local/share/xschem/xschem_library/devices/opin.sym} 320 -40 0 0 {name=p2 lab=OUT}
C {/usr/local/share/xschem/xschem_library/devices/ipin.sym} -110 0 0 0 {name=p1 lab=B}
C {/usr/local/share/xschem/xschem_library/devices/vdd.sym} 160 -180 0 0 {name=l1 lab=VDD}
C {/usr/local/share/xschem/xschem_library/devices/gnd.sym} 160 210 0 0 {name=l2 lab=GND}
C {/usr/local/share/xschem/xschem_library/devices/gnd.sym} 250 100 0 0 {name=l3 lab=GND}
C {/usr/local/share/xschem/xschem_library/devices/ipin.sym} -110 -60 0 0 {name=p3 lab=A}
C {/usr/local/share/xschem/xschem_library/devices/code_shown.sym} 410 -190 0 0 {name=2NAND only_toplevel=false 
...
.control
tran 10p 20n
meas TRAN tplh TRIG OUT VAL=0.9 RISE=1 TARG OUT VAL=1.62 RISE=1
meas TRAN tphl TRIG OUT VAL=1.62 FALL=1 TARG OUT VAL=0.9 FALL=1
